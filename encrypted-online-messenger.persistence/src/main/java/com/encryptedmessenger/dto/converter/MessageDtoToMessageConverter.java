...
public class MessageDtoToMessageConverter {
	...
	public Message convertMessageDtoToMessage(MessageDto messageDto) {
		...
		message.setSender(userConverter.getInstance().convertUserDtoToUser(messageDto.getSender()));
		message.setReceiver(userConverter.getInstance().convertUserDtoToUser(messageDto.getReceiver()));
	...
	public MessageDto convertMessageToMessageDto(Message message) {
		...
		messageDto.setSender(userConverter.getInstance().convertUserToUserDto(message.getSender()));
		messageDto.setReceiver(userConverter.getInstance().convertUserToUserDto(message.getReceiver()));
